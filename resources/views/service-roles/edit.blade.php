                    ...
                    <form action="{{ route('service-roles.update', $serviceRole) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Description du rôle et de ses responsabilités...">{{ old('description', $serviceRole->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="color" 
                                       ...
                                       id="color" 
                                       name="color" 
                                       value="{{ old('color', $serviceRole->color) }}"
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       name="is_active" 
                                       value="1" 
                                       {{ old('is_active', $serviceRole->is_active) ? 'checked' : '' }}>
                                <label class="form-check-label fw-semibold" for="is_active">
                                    Rôle actif
                                </label>
                            </div>
                            <small class="form-text text-muted">Les rôles inactifs n'apparaîtront pas dans la programmation des cultes.</small>
                        </div>
