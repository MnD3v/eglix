...
<div class="container py-4">
    <h1 class="h3 mb-3">Nouvelle dépense</h1>
    <form method="POST" action="{{ route('expenses.store') }}" class="card p-3">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-12">
                ...
                <input name="description" value="{{ old('description') }}" class="form-control @error('description') is-invalid @enderror">
