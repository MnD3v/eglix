...
<div class="container py-4">
    <h1 class="h3 mb-3">Modifier projet</h1>
    <form method="POST" action="{{ route('projects.update', $project) }}" class="card p-3">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="number" step="0.01" name="budget" value="{{ old('budget', $project->budget) }}" class="form-control @error('budget') is-invalid @enderror">
