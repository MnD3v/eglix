...
<div class="container py-4">
    <h1 class="h3 mb-3">Modifier dîme</h1>
    <form method="POST" action="{{ route('tithes.update', $tithe) }}" class="card p-3">
        @csrf
        @method('PUT')
        <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                ...
                <input type="number" step="0.01" name="amount" value="{{ old('amount', $tithe->amount) }}" class="form-control @error('amount') is-invalid @enderror" required>
            ...
            <div class="col-md-4" id="referenceField" style="display:none;">
                ...
                <input name="reference" value="{{ old('reference', $tithe->reference) }}" class="form-control @error('reference') is-invalid @enderror">
                @error('reference')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-12">
                <label class="form-label">Notes</label>
                <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3">{{ old('notes', $tithe->notes) }}</textarea>
