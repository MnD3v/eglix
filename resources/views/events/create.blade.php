...
<div class="container py-4">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Créez un nouvel événement pour l'église</p>
    </div>

    <form method="POST" action="{{ route('events.store') }}" class="form-card">
        @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" required placeholder="Ex: Conférence de Noël">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="type" class="form-control @error('type') is-invalid @enderror">
                        ...
                        <option value="Célébration" {{ old('type') == 'Célébration' ? 'selected' : '' }}>Célébration</option>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="location" value="{{ old('location') }}" class="form-control @error('location') is-invalid @enderror" placeholder="Ex: Salle principale">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Décrivez l'événement...">{{ old('description') }}</textarea>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <div id="images-repeater" class="image-repeater">
                        @php $oldImages = old('images', ['']); @endphp
