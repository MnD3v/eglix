...
<div class="container py-4">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <h1 class="page-title">Rapport des Offrandes</h1>
                <p class="page-subtitle">Analyse détaillée des offrandes reçues</p>
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('reports.offerings.export', ['from' => $from, 'to' => $to]) }}" class="btn btn-light">
        ...
        <div class="card-body">
            ...
            <form method="GET" id="periodForm">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        <a href="{{ route('reports.offerings') }}" class="btn btn-outline-secondary w-100">
    ...
    <div class="card card-soft mb-4">
        <div class="card-body">
            <h5 class="card-title mb-3">Évolution des Offrandes par Mois</h5>
        ...
        <div class="col-md-3">
            <div class="card card-soft text-center">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0">Nombre d'offrandes</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-soft text-center">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0">Moyenne par offrande</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="card card-soft">
        <div class="card-body">
            <h5 class="card-title mb-3">Détail des Offrandes</h5>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="member-avatar me-2" style="width: 32px; height: 32px; border-radius: 50%; background: #e8f0fe; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 0.8rem; color: #1a73e8;">
                                        {{ substr($offering->member->first_name, 0, 1) }}{{ substr($offering->member->last_name, 0, 1) }}
                                    </div>
                                    <div>
                                        <div class="fw-semibold">{{ $offering->member->last_name }} {{ $offering->member->first_name }}</div>
                                        <small class="text-muted">{{ $offering->member->email ?? 'Aucun email' }}</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="badge bg-{{ $offering->payment_method === 'cash' ? 'success' : ($offering->payment_method === 'mobile' ? 'info' : 'primary') }}">
                                    {{ ucfirst($offering->payment_method) }}
                                </span>
                            </td>
                            <td>{{ $offering->reference ?? '-' }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">
                                <i class="bi bi-inbox" style="font-size: 2rem;"></i>
                                <p class="mt-2 mb-0">Aucune offrande trouvée pour cette période</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(context) {
                            return 'Offrandes: ' + new Intl.NumberFormat('fr-FR').format(context.parsed.y) + ' FCFA';
                        }
                    }
                }
            },
