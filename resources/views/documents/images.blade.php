...
<div class="container-fluid py-4">
    ...
    <div class="section-header">
        ...
        <p class="section-subtitle">
            ...
            Toutes vos images, tous dossiers confondus
        </p>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <i class="mdi mdi-image me-1"></i>Images
                    </li>
                </ol>
            </nav>
        </div>
                ...
                <div class="card document-card h-100 shadow-sm border-0 document-clickable" 
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-start justify-content-between mb-3">
                            <div class="document-image-container" style="width: 60px; height: 60px;">
                                <img src="{{ $document->thumbnail_url }}" alt="{{ $document->name }}" 
                                     class="document-image" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                            </div>
                            <div class="document-badges">
                                <span class="badge bg-success-subtle text-success document-type-badge">
                ...
                <div class="text-center py-5">
                    <div class="empty-state">
                        <div class="empty-state-icon mb-4">
                            <i class="mdi mdi-image-outline text-muted" style="font-size: 4rem;"></i>
                        </div>
                        <h4 class="text-muted mb-3">Aucune image trouvée</h4>
                        <p class="text-muted mb-4">
                            Commencez par ajouter votre première image à votre bibliothèque.
                        </p>
                        <a href="{{ route('documents.create') }}" class="btn btn-primary">
                            <i class="mdi mdi-plus me-2"></i>Ajouter une image
                        </a>
                    </div>
                </div>
            </div>
