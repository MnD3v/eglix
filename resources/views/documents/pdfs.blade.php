...
<div class="container-fluid py-4">
    ...
    <div class="section-header">
        ...
        <p class="section-subtitle">
            ...
            Tous vos documents PDF, tous dossiers confondus
        </p>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <i class="mdi mdi-file-pdf-box me-1"></i>PDFs
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="stats-card">
                ...
                <div class="stats-content">
                    ...
                    <p class="stats-label">Total PDFs</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-start justify-content-between mb-3">
                            <div class="document-icon-wrapper">
                                <div class="document-icon bg-danger-subtle text-danger" style="width: 60px; height: 60px;">
                                    <i class="mdi mdi-file-pdf-box" style="font-size: 24px;"></i>
                                </div>
                            </div>
                            <div class="document-badges">
                                <span class="badge bg-danger-subtle text-danger document-type-badge">
                                    PDF
                                </span>
                ...
                <div class="text-center py-5">
                    <div class="empty-state">
                        <div class="empty-state-icon mb-4">
                            <i class="mdi mdi-file-pdf-outline text-muted" style="font-size: 4rem;"></i>
                        </div>
                        <h4 class="text-muted mb-3">Aucun PDF trouvé</h4>
                        <p class="text-muted mb-4">
                            Commencez par ajouter votre premier document PDF à votre bibliothèque.
                        </p>
                        <a href="{{ route('documents.create') }}" class="btn btn-primary">
                            <i class="mdi mdi-plus me-2"></i>Ajouter un PDF
                        </a>
                    </div>
                </div>
            </div>
